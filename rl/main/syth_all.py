...
from env import (
    calculate_reward,
    determine_color_transition,
    determine_distance_transition,
    get_colors,
    get_distances,
    get_actions,
    goal_achieved,
            ...
            for action in actions:
                for next_color in colors:
                    for next_distance in distances:
                        ...
                        distance_change = determine_distance_transition(
                            current_distance, next_distance
                        )
                        color_transition = determine_color_transition(
                        ...
                        experience = (
                            (current_color, current_distance),
                            action,
                            (next_color, next_distance),
                            reward,
                            done,
                        )
